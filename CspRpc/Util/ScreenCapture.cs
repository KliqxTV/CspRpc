...
public partial class ScreenCapture : IDisposable
{
    ...
    /// </summary>
    public ScreenCapture() : this(() => true) { }
    /// <summary>
    ...
    public ScreenCapture(Rectangle region) : this(region, () => true) { }
    /// <summary>
    ...
    /// <param name="x2">The x-coordinate of the bottom-right point of the region.</param>
    /// <param name="y2">The y-coordinate of the bottom-right point of the region.</param>
    public ScreenCapture(int x1, int y1, int x2, int y2) : this(x1, y1, x2, y2, () => true) { }
    /// <summary>
    ...
    public ScreenCapture(int monitor) : this(monitor, () => true) { }
    /// <summary>
    ...
    /// <summary>
    /// Disposes the resources used by this <see cref="ScreenCapture"/> instane, ensuring that the <see cref="Timer"/> no longer causes captures to be made.
    /// </summary>
    public void Dispose()
    {
